...
these are not all the rules that i try to follow. the other part is earlier described by me here: {{ site.url }}{{ site.baseurl }}2018/07/10/the-things-that-every-blogging-developer.html
...
- [a subset of mine – dedicated to everybody, not just myself]({{ site.url }}{{ site.baseurl }}2018/07/10/the-things-that-every-blogging-developer.html)
