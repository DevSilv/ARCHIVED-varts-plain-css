...
perhaps you had read that before or someone told you. but let us concentrate particularly on a blog's article. readers of your article may fulfil one or more of the following conditions:
...
- **long sentences** – readers might lost context of a sentence, or even the predicate (in general, it means: the verb).
- **long paragraphs** – readers might lost the context of a paragraph, the meaning of the current topic or the topic as a whole.
- **long listings** – readers might not understand what the listing does, or they might lost the way how a listing is related to the issue or subject that it illustrates (see also the tip nr 2).

consequently, to avoid that, try to write succintly. if an issue is too complex for a short sentence, paragraph or listing, just provide more sentences, paragraphs and listings.
...
probably you have read about it, so let me just remind: the examples are those places where the readers might compare your ideas with their own, practical world. generally, the more examples you provide, the more the readers will understand.

### 5. examples should speak for themselves.
...
### 6. readers should try to understand the article's subject, not the article.
...
### 7. reasons, reasons, reasons.

this tip is loosely relate to the previous one: readers should understand, why something is introduced in the article. therefore, wherever possible, explain why you wrote something. provide reasons, causes and motives both for all of the most difficult ideas and for the simplest. if you cannot, that might mean you should create a new article describing this thing.

### 8. try to use phrases like "whatever the case", "it does not matter" or "you should not care" only when necessary.
...
generally, it may be helpful to imagine such a relationship: you **know** when to consider a term or a concept less important that it seems to be, but the readers **do not know yet** (see also the tip nr 13).
...
### 10. if you describe several issues, mind the proportions.
...
### 11. choose the words that you already use.
...
### 12. be consistent when telling the readers what is right.
...
### 13. do not demand from the readers to leave your blog.
...
### 14. code rarely speaks for itself. images rarely speak for themselves. videos rarely speak for themselves. links rarely speak for themselves.
...
### 16. use phrases like "but", "however", "instead" or "although" cautiously.
...
### 17. use phrases like "may", "might", "can", "could", "must" and "have to" cautiously.
...
### 18. use phrases like "believe", "want to" and "seem" cautiously.
...
### 19. a note about "-" (or "–", or "—").

the characters: "-" (hypen<sup>1</sup>), "–" (en dash<sup>2</sup>) and "—" (em dash<sup>3</sup>) are commonly used (among other uses) to denote a part of a sentence which is **separated** from the rest. consequently, if you write one of those character in a sentence, the readers **may presume one of two things**:
...
then, suppose you had wanted to add the second character, but forgot it somehow. the readers may now assume one of two things:
